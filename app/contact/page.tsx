    ...
    <div className="container py-20">
      ...
      <Reveal className="mx-auto mt-12 grid max-w-3xl gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 text-sm text-white/60">Fastest response</p>
          <p className="mt-3 font-semibold text-brand">{SITE.WHATSAPP_NUMBER}</p>
        </a>

        <a
          href={emailLink("Bulk Inquiry")}
          className="group flex flex-col items-center rounded-2xl border border-white/15 bg-navy-100 p-8 text-center transition hover:border-brand/40"
        >
          ...
          <p className="mt-1 text-sm text-white/60">Detailed inquiries</p>
      ...
      <div className="mx-auto mt-16 grid max-w-5xl gap-10 lg:grid-cols-[1.4fr_1fr]">
        <Reveal>
          <div className="rounded-2xl border border-white/10 bg-navy-100 p-7 shadow-card sm:p-9">
        ...
        <Reveal delay={0.1}>
          <div className="space-y-6">
            {/* Highlights */}
            <div className="rounded-2xl border border-white/10 bg-navy-100 p-7 shadow-card">
              ...
              <div className="mt-5 flex gap-3">
                {[
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label={label}
                    className="flex h-11 w-11 items-center justify-center rounded-lg text-white/70 ring-1 ring-white/10 transition hover:text-brand hover:ring-brand/40"
                  >
